...
CREATE TABLE iteration (id BIGINT AUTO_INCREMENT, project_id BIGINT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX project_id_idx (project_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE migration_version (id BIGINT AUTO_INCREMENT, version BIGINT, PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE product (id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL, description TEXT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, slug VARCHAR(255), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE project (id BIGINT AUTO_INCREMENT, user_id BIGINT NOT NULL, product_id BIGINT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT, version VARCHAR(16) NOT NULL, website VARCHAR(255), status VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, slug VARCHAR(255), INDEX user_id_idx (user_id), INDEX product_id_idx (product_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE user_profile (id BIGINT AUTO_INCREMENT, user_id BIGINT UNIQUE NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, picture_url VARCHAR(255), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE working_unit (id BIGINT AUTO_INCREMENT, user_id BIGINT NOT NULL, task_id BIGINT NOT NULL, effort_spent BIGINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX user_id_idx (user_id), INDEX task_id_idx (task_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE sf_guard_user (id BIGINT AUTO_INCREMENT, username VARCHAR(128) NOT NULL UNIQUE, algorithm VARCHAR(128) DEFAULT 'sha1' NOT NULL, salt VARCHAR(128), password VARCHAR(128), is_active TINYINT(1) DEFAULT '1', is_super_admin TINYINT(1) DEFAULT '0', last_login DATETIME, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX is_active_idx_idx (is_active), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE user_per_team ADD CONSTRAINT user_per_team_user_id_user_profile_id FOREIGN KEY (user_id) REFERENCES user_profile(id) ON DELETE CASCADE;
