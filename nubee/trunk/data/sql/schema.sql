...
CREATE TABLE working_unit (id BIGINT AUTO_INCREMENT, user_id BIGINT NOT NULL, task_id BIGINT NOT NULL, effort_spent BIGINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX task_id_idx (task_id), PRIMARY KEY(id)) ENGINE = INNODB;
