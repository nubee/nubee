 ...
 * @method sfGuardUser         getAssignee()          Returns the current record's "Assignee" value
 ...
 * @method Task                setAssignee()          Sets the current record's "Assignee" value
...
abstract class BaseTask extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasOne('sfGuardUser as Assignee', array(
             'local' => 'user_id',
             'foreign' => 'id',
             'onDelete' => 'CASCADE'));
