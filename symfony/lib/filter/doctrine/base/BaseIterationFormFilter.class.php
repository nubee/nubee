...
/**
 * Iteration filter form base class.
 *
 * @package    nubee
 * @subpackage filter
 ...
 */
abstract class BaseIterationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('iteration_filters[%s]');
